...
description: Lightweight mandatory readiness check before creating or materially revising a component-based interactive wireframe.
---
...
- For Tata 1mg work, the Dopamine 2.0 wireframe reference is loaded and the relevant component/token rules are identified.
...
When no visual source was supplied, use the Dopamine construction system in `wireframe-visual-language.md`; do not invent unsupported product patterns.
