...
Go through everything on the board: selected frames and their order, frame names and labels, screenshots and UI states, flow arrows and connectors, sticky notes and annotations, highlighted areas and callouts, the author's prompt and recent conversation.
