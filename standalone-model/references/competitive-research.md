...
description: Compare a bounded set of competitors or adjacent products to understand category patterns, user expectations, and opportunities, using targeted web research and screenshots when they materially help.
---
...
When the user directly supplies competitor screenshots and the core problem has already been interpreted, analyse those screenshots in this stage. Do not send them through a second general evidence-interpretation pass.
...
## Prioritise transferable patterns

For user-supplied competitor references, classify each extracted pattern as:

- **Must have** — necessary to resolve the supported user breakdown, prevent a material error, or meet the trust and clarity boundary.
- **Good to have** — meaningfully improves comprehension or effort but is not essential to the first responsible direction.
- **Could have** — useful only for a narrower context, later maturity, or a non-critical enhancement.
- **Do not carry over** — misleading, weak, context-specific, inaccessible, or contrary to the supported problem and principles.

Priority must follow the product problem and evidence, not competitor frequency. Keep observations separate from the judgment about transferability.
...
**Pattern comparison**
| Reference | Observed pattern | What is good | Risk or limitation | Priority | Implication for our direction |
| --- | --- | --- | --- | --- | --- |
| ... | ... | ... | ... | Must have / Good to have / Could have / Do not carry over | ... |
