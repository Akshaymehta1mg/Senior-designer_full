---
name: user-story
description: Build a believable, editable account of the user's situation, behavior, difficulty, and desired progress before shaping the experience.
---
...
The main workflow's mandatory discovery question applies before this artifact is produced. Do not add a separate confirmation question when the story is already sufficient for responsible progress. Continue with clearly marked assumptions unless another gap would change the framing, direction, or safety of the design.
