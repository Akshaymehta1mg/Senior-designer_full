...
Before writing, use the main workflow's mandatory discovery question to clarify the decision the research should inform, who or what the team can learn from, what is already known, or which constraints affect the session. Ask additional questions only for missing information that would materially change the script.
